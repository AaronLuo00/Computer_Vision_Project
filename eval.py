...
parser.add_argument('--model',
                    help='model type to train or test, specify a number between 1-7 or one of [\'1_generator_base_l1_loss\', \'2_generator_base_fml_loss\', \'3_generator_base_l1_and_fml_loss\', \'4_generator_resnet_l1_loss\', \'5_generator_residual_unet_l1_loss\',  \'6_generator_base_l1_loss_pretrained\']',
                    type=str,
...
if args.model == '2_generator_base_fml_loss' or args.model == '2':
    config.MODEL_NAME = '2_generator_base_fml_loss'
    config.GENERATOR_TYPE = 'UNet'

if args.model == '3_generator_base_l1_and_fml_loss' or args.model == '3':
    config.MODEL_NAME = '3_generator_base_l1_and_fml_loss'
    config.GENERATOR_TYPE = 'UNet'
...
if args.model == '6_generator_base_l1_loss_pretrained' or args.model == '7':
    config.MODEL_NAME = '6_generator_base_l1_loss_pretrained'
